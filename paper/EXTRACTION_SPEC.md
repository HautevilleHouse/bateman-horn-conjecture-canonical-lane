...
- `kappa_density` from `c_density_raw * density_gain_raw - e_density_raw`
- `sigma_pattern` from `pattern_floor_raw - singular_loss_raw - restart_loss_raw`
- `kappa_compact` from `1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity` from `rho_rigidity_raw`
- `horn_transfer` from `c_transfer_raw * transfer_gain_raw - e_transfer_raw`
