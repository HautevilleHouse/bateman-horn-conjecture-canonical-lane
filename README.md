...
Canonical Lane research workspace for a flagship umbrella problem in analytic number theory:
proving persistence of the Bateman-Horn prime-density law for admissible polynomial families through an admissible prime-pattern density closure architecture.

## Main Manuscript

- [paper/BATEMAN_HORN_CONJECTURE_PREPRINT.md](paper/BATEMAN_HORN_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `BATEMAN_HORN_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/BATEMAN_HORN_CONJECTURE_PREPRINT.md`.
...
Current BH runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/bh_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/bh_closure_guard.py`.
...
- Manuscript target: [paper/BATEMAN_HORN_CONJECTURE_PREPRINT.md](paper/BATEMAN_HORN_CONJECTURE_PREPRINT.md)
